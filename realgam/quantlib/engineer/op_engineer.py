...
class OpEngineer(BaseEngineer):
    ...
    def ts_retn(self, price_col: str, n: int = 2, inplace: bool = False):
        """
    ...
    def ts_std(self, price_col: str, n: int = 20, inplace: bool = False):
        """
    ...
    def ts_lag(self, col: str, n: int = 1, inplace: bool = False):
        """
    ...
    def ts_sum(self, col: str, n: int = 1, inplace: bool = False):
        """
    ...
    def ts_product(self, col: str, n: int = 1, inplace: bool = False):
        """
    ...
    def ts_delta(self, col, n: int = 1, inplace: bool = False):
        """
    ...
    def ts_rank(self, col: str, n: int, inplace: bool = False, **kwargs):
        ...
        :return: if inplace == False, return pd.Series
        """
        eng_values = self.df[col].rolling(n).apply(rank_last_value, raw=True)
...
class GroupOpEngineer(GroupBaseEngineer):
    ...
    def ts_rank(self, col: str, n: int, inplace: bool = False, **kwargs):
        ...
        :return: if inplace == False, return pd.Series
        """
        eng_values = self.df.groupby(self.groupby_col)[col].rolling(n).apply(rank_last_value, raw=True)
